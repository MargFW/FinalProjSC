...
class Player(arcade.Sprite):
        ...
        **Returns**
        ...
        if self.legs == 2:
            for i in range(self.start):
                self.robot_textures.append(
                                           arcade.load_texture(
                                               "Images/twonormal.png"))
            for i in range(self.frames):
                self.robot_textures.append(
                                           arcade.load_texture(
                                               "Images/twoswell1.png"))
            for i in range(self.frames):
                self.robot_textures.append(
                                           arcade.load_texture(
                                               "Images/twoswell2.png"))
            for i in range(self.frames):
                self.robot_textures.append(
                                           arcade.load_texture(
                                               "Images/twoswell1.png"))
            ...
            for i in range(self.frames):
                self.robot_textures.append(
                                           arcade.load_texture(
                                               "Images/twodeswell1.png"))
            for i in range(self.frames):
                self.robot_textures.append(
                                           arcade.load_texture(
                                               "Images/twodeswell2.png"))
            for i in range(self.frames):
                self.robot_textures.append(
                                           arcade.load_texture(
                                               "Images/twodeswell1.png"))
        ...
        if self.legs == 4:
            for i in range(self.start):
                self.robot_textures.append(
                                           arcade.load_texture(
                                               "Images/fournormal.png"))
            for i in range(self.frames):
                self.robot_textures.append(
                                           arcade.load_texture(
                                               "Images/fourswell1.png"))
            for i in range(self.frames):
                self.robot_textures.append(
                                           arcade.load_texture(
                                               "Images/fourswell2.png"))
            for i in range(self.frames):
                self.robot_textures.append(
                                           arcade.load_texture(
                                               "Images/fourswell1.png"))
            ...
            for i in range(self.frames):
                self.robot_textures.append(
                                           arcade.load_texture(
                                               "Images/fourdeswell1.png"))
            for i in range(self.frames):
                self.robot_textures.append(
                                           arcade.load_texture(
                                               "Images/fourdeswell2.png"))
            for i in range(self.frames):
                self.robot_textures.append(
                                           arcade.load_texture(
                                               "Images/fourdeswell1.png"))
    ...
    def update_animation(self, delta_time: float = 1):
        ...
        **Returns**
        ...
        """
        total = (self.frames*8)+self.start+20
        if self.currentrobot >= total-1:
            self.currentrobot = self.start
        else:
            self.currentrobot += 1
    ...
    def on_draw(self):
        ...
        **Returns**
        ...
        arcade.draw_text("INSTRUCTIONS", self.window.width / 2, 450,
                         arcade.color.WHITE, font_size=50, anchor_x="center")
        arcade.draw_text("You will provide the game with the desirred robot",
                         self.window.width / 2, 350,
                         arcade.color.WHITE, font_size=15, anchor_x="center")
        arcade.draw_text("design. ROBO RUNNER will show actuation. PLEASE",
                         self.window.width / 2, 320,
                         arcade.color.WHITE, font_size=15, anchor_x="center")
        arcade.draw_text("LOOK AT IPYTHON CONSOLE TO ENTER NUMBER OF LEGS",
                         self.window.width / 2, 290,
                         arcade.color.WHITE, font_size=15, anchor_x="center")
        arcade.draw_text("AFTER PRESSING CONTINUE.",
...
class RoborunView(arcade.View):
    ...
    def setup(self):
        ...
        **Returns**
        ...
        if self.player_sprite.legs == 4:
            self.distance = -6.32
        if self.player_sprite.legs == 3:
            self.distance = -3.92
        if self.player_sprite.legs == 2:
            self.distance = -2.4
    ...
    def add_hotwater(self, delta_time: float):
        ...
        **Returns**
        ...
        """
        hotwater = arcade.Sprite("Images/redline.png", 2)
        hotwater.left = 800
    ...
    def add_coldwater(self, delta_time: float):
        ...
        **Returns**
        ...
        """
        coldwater = arcade.Sprite("Images/blueline.png", 2)
        coldwater.left = 1575
